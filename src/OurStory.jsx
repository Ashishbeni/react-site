 ...
 <>
    <div className={style.main}>
     <div className={style.heading}>
      <h1>OurStory</h1>
      <p>MurrahGold ki shuruaat ek simple soch se hui —
...
Hum maante hain ki ek strong brand sirf products se nahi, balki relationships se banta hai. Isi liye MurrahGold sirf ek naam nahi, balki ek rishta hai jo hum apne customers ke saath har roz aur mazboot banate hain.</p>
     </div>
